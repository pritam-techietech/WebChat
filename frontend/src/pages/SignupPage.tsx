...
const SignupPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto w-fit">
      <div className="w-full bg-gray-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-70 border border-gray-100 p-6 max-w-full">
        <>
          ...
          <form className="my-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Link
              to="/login"
              className="text-white text-sm mt-4 hover:underline hover:text-red-400"
            >
